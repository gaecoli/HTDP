...
(define SCENE-WIDTH (* 9 (image-width CHAM)))
(define SCENE-HEIGHT (* 2 (image-height CHAM)))
(define CHAM-Y (* 0.6667 SCENE-HEIGHT))

(define CANVAS
  (beside (empty-scene (/ SCENE-WIDTH 3) SCENE-HEIGHT "green")
